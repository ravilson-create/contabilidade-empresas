    ...
    itens: [
      {
        ...
        buscaLocal: "Sefaz",
        paraQue:
          "Inscrição estadual, obrigatória para quem revende ou fabrica mercadorias (ICMS). Pesquise 'Sefaz [seu estado]' para o site direto.",
      },
      {
        ...
        paraQue:
          "Alvará de funcionamento, inscrição municipal e recolhimento do ISS. Procedimento varia por cidade — pesquise 'prefeitura de [sua cidade] alvará'.",
      },
    ],
  },
  {
