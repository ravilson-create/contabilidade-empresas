...
export const SERVICOS = [
  ...
  },
  {
    ...
    categoria: "funcionarios",
    icone: "📤",
    titulo: "Demitir um funcionário",
    descricao: "Calcula as verbas rescisórias conforme o motivo do desligamento — aviso prévio, 13º e férias proporcionais, multa do FGTS — e o prazo de pagamento.",
    recomendadoSe: () => false,
  },
  {
    id: "nota-fiscal",
  ...
  },
  {
    ...
    categoria: "notas",
    icone: "📎",
    titulo: "Saber o que será retido na nota fiscal",
    descricao: "INSS, IRRF ou PIS/COFINS/CSLL retidos pelo tomador — depende do serviço, de quem paga e se você está no Simples Nacional.",
    recomendadoSe: (p) => p.enquadramento !== "ainda_nao_abri",
  },
  {
    id: "prolabore",
    categoria: "impostos",
    icone: "🧑‍💼",
    titulo: "Calcular o pró-labore do sócio",
    descricao: "INSS (11%, com teto) e IRRF sobre o pró-labore, diferente do cálculo de salário de empregado.",
    recomendadoSe: (p) => p.enquadramento === "meepp",
  },
  {
    id: "lucro-presumido",
    categoria: "impostos",
    icone: "🧮",
    titulo: "Tributos fora do Simples (Lucro Presumido)",
    descricao: "IRPJ, CSLL, PIS, COFINS e ISS de quem está fora do Simples Nacional — por opção ou por exclusão.",
    recomendadoSe: (p) => p.declaracoesEmDia === "nao" || p.declaracoesEmDia === "nao_sei",
  },
  {
    id: "encerramento",
