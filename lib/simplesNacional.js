...
// Sugestão inicial de Anexo a partir da atividade coletada no perfil da
// empresa — apenas um ponto de partida; o usuário confirma ou troca.
export function anexoSugeridoPorAtividade(atividade) {
  if (atividade === "comercio") return "I";
  if (atividade === "industria") return "II";
  if (atividade === "servico") return "III";
  return "";
}
